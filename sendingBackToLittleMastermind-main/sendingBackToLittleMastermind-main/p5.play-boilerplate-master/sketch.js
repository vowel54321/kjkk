...
GameoverImg=loadAnimation("propername.jpg")
...
GO= createSprite(displayWidth/2-20,300,500,500)
GO.scale=1.2;  
GO.addAnimation("GameOverImg",GameoverImg);
  GO.visible=false;
